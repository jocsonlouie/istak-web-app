<template>
    ...
    <transition name="modal-animation">
        <div v-show="modalActiveAdminNotif"
                                ...
                                <div class="bg-white px-5 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="sm:flex justify-center mb-10 mt-10">
                                        <div class="mt-3 sm:mt-0 sm:ml-4">
                                            <h3 class="mt-16 text-center text-2xl font-medium leading-6 text-gray-900"
                                                id="modal-title">Roles Change.The owner was advised of the alteration.</h3>
                                        </div>
                                    </div>
